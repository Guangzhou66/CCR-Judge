...
print(f"[run_ccr_ablation] python={sys.executable}")
print(f"[run_ccr_ablation] cuda_device={torch.cuda.get_device_name(0)}")
PY

"${PYTHON_BIN}" "${SCRIPT_DIR}/run_ccr_ablation.py" \
