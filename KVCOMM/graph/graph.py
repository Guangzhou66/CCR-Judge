        ...
        **kwargs,
        ...
        if mode == "default":
            ...
            if self.decision_node:
                ...
                final_answers = self.decision_node.outputs
                final_meta = getattr(self.decision_node, "outputs_meta", [])
                if len(final_answers) == 0:
                    final_answers.append("No answer of the decision node")
            ...
            return {
                ...
                "decision_metadata": final_meta if self.decision_node else None,
            }
        ...
        if mode == "allow_kv_reuse":
            ...
            if self.decision_node:
                ...
                final_meta = getattr(self.decision_node, "outputs_meta", {}).get(input["task"], [])
                if len(final_answers) == 0:
                    final_answers.append("No answer of the decision node")
