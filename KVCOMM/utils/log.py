...
def configure_logging(
    ...
    """
    logger.remove()
    console_level = os.getenv("KVCOMM_CONSOLE_LOG_LEVEL", print_level).strip().upper()
    console_disabled = _env_flag("KVCOMM_PROGRESS_ONLY") or _env_flag("KVCOMM_DISABLE_CONSOLE_LOG")
    if console_disabled:
        ...
        try:
            ...
            pass
    if not console_disabled and console_level not in {"", "NONE", "OFF", "QUIET"}:
